...
class Dashboard(tk.Tk):
    ...
    def carica_modelli(self):
        ...
        try:
            ...
            file_categoria = os.path.join(base_path,"Logistic_Regression_definitiva_categorie.pkl")
            file_priorita = os.path.join(base_path,"Logistic_Regression_definitiva_priorita.pkl")
